...
│   ├── presentation-outline.md      fourteen-slide / 20-minute architecture; Slides 1–8 developed
│   ├── presenter-notes.md           delivery cues, Slides 1–8
│   └── exercises.md                 29 exercises, Slides 1–8
├── shared/
...
with **Slides 1–3 `ACCEPTED after T7-D-R`** and **Slides 4–8 developed in
`T7-E`** (presenter notes and 29 exercises cover Slides 1–8), status
**`TEACHING CONTENT IN DEVELOPMENT — T7-E PENDING CHATGPT GOVERNANCE
REVIEW`**; **Slides 9–14 are `NOT YET DEVELOPED`**, and no visual or
